export const testimonials = [
    {
      id: 1,
      customerName: "Keluarga Bagus Muhammad Nur",
      category: "custom",
    ...
    },
    {
      ...
      colors: [
        ...
        { name: "Blueberry", hex: "#292E4C" }
      ],
      printingMethod: {
        image: "/images/teknikbatik2.png",
        description: "Kombinasi teknik batik tulis dan cap dengan pewarnaan khusus untuk menghasilkan motif yang detail dan mewah."
      }
    },
    {
      id: 3,
      customerName: "Losinta Entertainment",
      category: "retail",
      ...
      colors: [
        ...
        { name: "Abu-Abu", hex: "#7F7D80" }
      ],
      printingMethod: {
        image: "/images/teknikbatik3.jpg",
        description: "Teknik printing digital modern dikombinasikan dengan sentuhan batik tradisional untuk hasil yang dinamis."
      }
    }
  ];